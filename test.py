...
class TestCalculator(unittest.TestCase):#unittest odule provides a set of tools for constructing and running scripts, we will test features of online calculator in this case
	...
	def test_sub(self):
		...
		solution = self.app.get('/sub?A=3/2&B=1/3')
		self.assertEqual(b'1.16666666667', solution.data)
		...
		self.assertEqual(b'-10', solution.data)#non integer type considered as not valid , in this case which is zero
